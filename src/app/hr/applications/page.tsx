...
export default function ApplicationsPage() {
  const [applications, setApplications] = useState<{ _id: string; candidate: { name: string }; job: { _id: string; title: string }; status: string; matchScore: number }[]>([]);
      ...
      {loading ? (
        ...
        <div className="space-y-4">
          {filteredApplications.map(app => (
            <div key={app._id} className="border p-4 rounded shadow flex justify-between items-center">
              <div>
