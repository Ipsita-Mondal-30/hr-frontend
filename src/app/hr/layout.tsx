...
const hrNavLinks = [
  ...
  { href: '/hr/profile', label: 'My Profile', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
          ...
          <div className="p-4 sm:p-6 max-w-full">
            {user?.role === 'hr' && !user?.isVerified && (
              <div className="mb-4 rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-900">
                Your HR account is pending admin verification. Complete your{' '}
                <Link href="/hr/profile" className="font-semibold underline">
                  profile
                </Link>{' '}
                (phone &amp; position), then wait for approval before posting jobs.
              </div>
            )}
            {children}
          </div>
