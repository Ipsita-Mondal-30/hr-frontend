...
export function TestimonialsSection() {
  ...
  const testimonials = [
    {
      quote: "Talora transformed our hiring process completely. The AI matching is incredibly accurate, and we've reduced our time-to-hire by 60%. The platform is intuitive and our team adopted it seamlessly.",
      author: "Sarah Chen",
    ...
    {
      quote: "The analytics dashboard gives us insights we never had before. We can now predict hiring trends and make data-driven decisions. It's been a game-changer for our recruitment strategy.",
    ...
    {
      quote: "As a candidate, the experience was exceptional. The application process was smooth, communication was transparent, and I felt valued throughout. It's clear why companies choose Talora.",
      author: "Emily Watson",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          ...
          <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
            ...
            <br />
            <span className="bg-gradient-to-r from-purple-600 to-cyan-600 bg-clip-text text-transparent">our work</span>
          </h2>
          
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Don't just take our word for it. See what our clients and candidates 
            have to say about their experience with Talora.
          </p>
        </div>
